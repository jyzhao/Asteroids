...
public class Sprite {
	...
	// Asteroid Type = "parent" if first time asteroid, = "child" if its one of
	// three asteroids that spawned from a bullet hit asteroid
	...
	private double getRadius() {
		return Math.sqrt(Math.pow(this.getWidth() / 2, 2)
